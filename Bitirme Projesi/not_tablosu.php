...
<head>
  ...
  <title>Tablolar / Not Tablosu</title>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="not_tablosu.php" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Not Tablosu</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">      
          <div class="card">
            <div class="card-body">
              ...
              <!-- End Bordered Table -->
              <a href="not_tablosu.php?csv=''" class="btn btn-primary"><i class="bi bi-folder"></i> CSV Dosyasına Aktar</a>
            </div>
          </div>        
